import type { Destination, Homestay } from "@prisma/client";
import { prisma } from "@server/infra/db";
import { estimateTripCost, type CostBreakdown, type RiderType, type StayStyle } from "@server/domain/costs";
