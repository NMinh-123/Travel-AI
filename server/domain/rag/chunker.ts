...
/**
 * Phiên bản cách cắt đoạn. TĂNG LÊN mỗi khi sửa `CHUNK_PROFILES`, `chunkText` hoặc cách chọn hồ
 * sơ ở scripts/ingest-knowledge.ts.
 *
 * Đây là công tắc buộc đánh chỉ mục lại toàn bộ. Ingest tăng dần so vân tay nội dung để quyết định
 * có embed lại hay không, mà đổi cách cắt đoạn thì ranh giới đoạn đổi trong khi từng đoạn vẫn có
 * thể trùng vân tay cũ — khi đó kho ở lại với cách cắt cũ và không có gì báo. Con số này là thứ
